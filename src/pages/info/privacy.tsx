...
import styles from '../../styles/info/privacy.module.css' // Import login.module.css
    ...
    <div>
      ...
      <div>
        <div>
          ...
          <div className={styles.pDivStyle} aria-hidden="true"></div>

          <p>
            &lt;(주)‘Ocho’ &gt;(‘www.what2do.co.kr’이하 ‘Ocho’) 은 다음의 목적을
          ...
          <p>
            {' '}
            ① ‘Ocho’는 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보
            보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서
            개인정보를 처리․보유합니다.
            <br />
            <br />② 구체적인 개인정보 처리 및 보유 기간은 다음과 같습니다.
            <br />– 고객 가입 및 관리 : 카카오싱크를 통한 회원가입 및
            카카오채널을 통한 관리
          ...
          <p>
            ① 정보주체는 ‘오늘뭐하지’ 에 대해 언제든지 다음 각 호의 개인정보
          ...
          <p>
            ① <em>‘오늘뭐하지’</em>은 다음의 개인정보 항목을 처리하고 있습니다.
          </p>

          <div className={styles.pDivStyle} aria-hidden="true"></div>

          <p>
            &lt;<strong>‘오늘뭐하지’에서 수집하는 개인정보 항목</strong>&gt;
            <br />
            ‘오늘뭐하지’ 회원 가입 및 고객 문의 시, 제공 동의를 해주시는
            개인정보 수집 항목입니다.
          </p>
          ...
          <p>
            ■ <strong>회원 가입 시</strong>(회원)
            <br />– 필수항목 : 이름, 이메일, 전화번호, 성별, 연령대
            <br />– 선택항목 : 생년월일 <br />– 수집목적 : 오늘뭐하지 회원관리
            및 마케팅 이용
          ...
          <p>
            ■ <strong>고객 문의 시</strong>(비회원)
            <br />– 필수항목 : 문의종류, 이름, 휴대폰번호, 이메일, 문의사항
            <br />– 수집목적 : 고객문의 및 상담요청에 대한 회신, 상담을 위한
            서비스 이용기록 조회 <br />– 보유기간 : 문의 접수 후 2년 간 보관
            (단, 관계 법령이 정한 시점까지 보존)
          </p>
          ...
          <p>
            &lt;<strong>카카오 개인정보 제3자 제공 동의</strong>&gt;
            <br />
            아래는 ‘어반러드렛’ 회원 가입 시(카카오 계정을 통한 간편 가입시)
            제공 동의를 해주시는 자동 수집 항목입니다.
          </p>
          ...
          <p>
            ...
            <br />– 선택항목 : 생일, 출생연도 <br />– 수집목적 : 오늘뭐하지
            카카오채널을 통한 회원관리 및 마케팅 이용
            <br />– 보유기간 : 카카오채널 탈퇴 또는 동의철회 시 지체없이 파기
          </p>

          <div className={styles.pDivStyle} aria-hidden="true"></div>

          <p>
            ② <em>‘오늘뭐하지’</em>은 만 14세 미만 아동의 개인정보를 보호하기
          ...
          <p>
            ‘Ocho’는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이
          ...
          <p>
            ① ‘Ocho’는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
          ...
          {/* <p>
            ① ‘Ocho’는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
          ...
          <p>
            <br />② ‘오늘뭐하지’의 서비스(또는 사업)을 이용하시면서 발생한 모든
            개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
            개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.{' '}
          </p>

          <p>
            ‘Ocho’는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
            것입니다.
          </p>
          ...
          <p>
            <strong>9. 개인정보의 안전성 확보 조치&nbsp;</strong>
            <br />
            <strong>
              <em>‘오늘뭐하지’</em>은 개인정보보호법 제29조에 따라 다음과 같이
          ...
          <p>
            <br />② 해킹 등에 대비한 기술적 대책
            <br />
            ‘Ocho’는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
          ...
          <p>
            아래의 기관은 (주)제이피 이노베이션 과는 별개의 기관으로서,&nbsp;
            <em>‘오늘뭐하지’</em>의 자체적인 개인정보 불만처리, 피해구제 결과에
