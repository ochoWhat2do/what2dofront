...
import styles from '../../styles/info/policy.module.css' // Import policy.module.css
  ...
  return (
    <div>
      ...
      <div className={styles.conbody}>
        <p>
          <span className={styles.pTitleSpan}>
            <span className={styles.pTitleSpan}>제 1 장 총 칙</span>
          </span>
        </p>
        <p>&nbsp;</p>
        <p>
          <span className={styles.pTitleSpan}>
            <span className={styles.pTitleSpan}>
              제 1 조 (목적)
              <br />이 약관은 Ocho(이하 "사이트"라 합니다)에서 제공하는
        ...
        <p>
          <span className={styles.pTitleSpan}>
            <span className={styles.pTitleSpan}>
              ...
              데이터인 것으로 간주됩니다. 실명이나 실제 정보를 입력하지 않은
        ...
        <p>
          <span className={styles.pTitleSpan}>
            <span className={styles.pTitleSpan}>
              ...
              해당하여 이용계약을 해지하고자 할 경우에는 해지조치 7일전까지 그
